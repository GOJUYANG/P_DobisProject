...
class BattleClass(QMainWindow, main_class):
    def __init__(self, **kwargs):
        ...
        if self.bool_meet_monster:
            ...
            self.list_job_skill[0].clicked.connect(lambda: self.skill_connect(self.list_job_skill[0]))
            self.list_job_skill[1].clicked.connect(lambda: self.skill_connect(self.list_job_skill[1]))
            self.list_job_skill[2].clicked.connect(lambda: self.skill_connect(self.list_job_skill[2]))
            self.list_job_skill[3].clicked.connect(lambda: self.skill_connect(self.list_job_skill[3]))
            self.list_job_skill[4].clicked.connect(lambda: self.skill_connect(self.list_job_skill[4]))
            self.list_job_skill[5].clicked.connect(lambda: self.skill_connect(self.list_job_skill[5]))
            self.list_job_skill[6].clicked.connect(lambda: self.skill_connect(self.list_job_skill[6]))
            self.list_job_skill[7].clicked.connect(lambda: self.skill_connect(self.list_job_skill[7]))
            self.list_job_skill[8].clicked.connect(lambda: self.skill_connect(self.list_job_skill[8]))
            self.list_job_skill[9].clicked.connect(lambda: self.skill_connect(self.list_job_skill[9]))
            self.list_job_skill[10].clicked.connect(lambda: self.skill_connect(self.list_job_skill[10]))
            self.list_job_skill[11].clicked.connect(lambda: self.skill_connect(self.list_job_skill[11]))
            self.list_job_skill[12].clicked.connect(lambda: self.skill_connect(self.list_job_skill[12]))
            self.list_job_skill[13].clicked.connect(lambda: self.skill_connect(self.list_job_skill[13]))
            self.list_job_skill[14].clicked.connect(lambda: self.skill_connect(self.list_job_skill[14]))
            self.list_job_skill[15].clicked.connect(lambda: self.skill_connect(self.list_job_skill[15]))
            self.list_job_skill[16].clicked.connect(lambda: self.skill_connect(self.list_job_skill[16]))
            self.list_job_skill[17].clicked.connect(lambda: self.skill_connect(self.list_job_skill[17]))
            self.list_job_skill[18].clicked.connect(lambda: self.skill_connect(self.list_job_skill[18]))
            self.list_job_skill[19].clicked.connect(lambda: self.skill_connect(self.list_job_skill[19]))
            self.list_job_skill[20].clicked.connect(lambda: self.skill_connect(self.list_job_skill[20]))
            self.list_job_skill[21].clicked.connect(lambda: self.skill_connect(self.list_job_skill[21]))
        ...
        #     lambda: self.wizard_skill_effect_2('wizard_red', 'fire_ball', 'part', 30, 30))
        # self.skill_btn_wizard_red_fire_wall.clicked.connect(
        #     lambda: self.wizard_skill_effect_2('wizard_red', 'fire_wall', 'all', 50, 50))
        # self.skill_btn_wizard_red_thunder_breaker.clicked.connect(
        #     lambda: self.wizard_skill_effect_2('wizard_red', 'thunder_breaker', 'all', 60, 60, ))
        # self.skill_btn_wizard_red_bilzzard.clicked.connect(
        #     lambda: self.wizard_skill_effect_2('wizard_red', 'blizzard', 'all', 70, 70))
        #
        # self.skill_btn_wizard_black_fire_ball.clicked.connect(
        #     lambda: self.wizard_skill_effect_2('wizard_black', 'fire_ball', 'part', 30, 30, ))
        # self.skill_btn_wizard_black_fire_wall.clicked.connect(
        #     lambda: self.wizard_skill_effect_2('wizard_black', 'fire_wall', 'all', 50, 50))
        # self.skill_btn_wizard_black_thunder_breaker.clicked.connect(
        #     lambda: self.wizard_skill_effect_2('wizard_black', 'thunder_breaker', 'all', 60, 60))
        # self.skill_btn_wizard_black_bilzzard.clicked.connect(
        #     lambda: self.wizard_skill_effect_2('wizard_black', 'blizzard', 'all', 70, 70))
        #
    ...
    def skill_connect(self, btn):
        ...
        for i in range(loop):
            ...
            elif btn == self.list_job_skill[11]:
                self.list_enemy_btn[i].clicked.connect(
    ...
    def user_gard_lv_update(self, int_war_cnt, bool_boss_death):
        str_lv_update_msg1 = ''
        str_lv_update_msg2 = ''
        list_update_job1 = []
        list_update_job2 = []
    ...
    def wizard_skill_effect(self, str_job, str_skill_name, str_part_or_all, int_min, int_max, int_mp):
        ...
        if str_part_or_all == 'part':
            ...
            self.battle_dialog.append(
                f"{str_job}의 {str_skill_name}사용으로 {low_hp_job}의 체력이 최대체력의 {heal}% 증가하여 {self.dict_user_gard['swordsman']['max_hp'] * (heal / 100)}만큼 올랐다! ")
...
{list_target[int_monster_target_c]}의 hp가 {self.dict_user_gard[list_target[int_monster_target_c]]['hp']:.1f}로 떨어졌다!"""
                print(
                    f"{list_target[int_monster_target_c]} 현 hp : {self.dict_user_gard[list_target[int_monster_target_c]]['hp']}")
                print(f"-받은 데미지 : {self.dict_field_monster['info']['hp'][atk_monster] * damage_num}")

            elif damage_key == 'skill':
                if int_skill_sucess <= 30:
                    self.dict_user_gard[list_target[int_monster_target_c]]['hp'] -= \
                        self.dict_field_monster['info']['hp'][atk_monster] * damage_num
                    self.battle_msg = f"""{self.dict_field_monster['area']}의 {self.atk_mon}가 {damage_name}공격을 걸었다!
{list_target[int_monster_target_c]}의 hp가 {self.dict_user_gard[list_target[int_monster_target_c]]['hp']:.1f}로 떨어졌다!"""
                    print(
                        f"{list_target[int_monster_target_c]} 현 hp : {self.dict_user_gard[list_target[int_monster_target_c]]['hp']}")
        ...
        # 던전에서 지역몬스터를 만났다.
            ...
            for i in range(self.dict_maze_monster['int_cnt']):
                ...
                if self.dict_maze_monster['list_hp'][i] <= 0:
                    print(self.monster_li[atk_monster])
                    print(self.dict_maze_monster['list_hp'][atk_monster])
                    continue
            ...
            if monster_damage == 0.05:
                self.dict_user_gard[list_target[int_monster_target_c]]['hp'] -= self.dict_maze_monster['list_hp'][
                                                                                    atk_monster] * \
                                                                                self.dict_maze_monster['list_damage'][
                                                                                    atk_monster]
    ...
    그 영향으로 {list_target[int_monster_target_c]}의 hp가 {self.dict_user_gard[list_target[int_monster_target_c]]['hp']:.1f}로 떨어졌다!"""
                ...
                if int_skill_sucess <= 30:
                    self.dict_user_gard[list_target[int_monster_target_c]]['hp'] -= self.dict_maze_monster['list_hp'][
                                                                                        atk_monster] * \
                                                                                    self.dict_maze_monster[
                                                                                        'list_damage'][atk_monster]
...
그 영향으로 {list_target[int_monster_target_c]}의 hp가 {self.dict_user_gard[list_target[int_monster_target_c]]['hp']:.1f}로 떨어졌다!""")
        ...
        if self.dict_user_gard[list_target[int_monster_target_c]]['hp'] <= 0:
            ...
            self.battle_monster(self.dict_user_gard)
            QTimer.singleShot(1000, lambda: self.show_war_result())
