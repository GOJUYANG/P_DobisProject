...
class DungeonClass():
    ...
    def move_event(self, int_floor):
        ...
        # if (user_y, user_x) == self.boss_location(self.int_floor):
        #     print('보스전 시작')
    ...
    def meet_ally_gard(self):
        ...
        # 차후 머시기 저시기해서 GUI 연결하고 개수 1개 늘어나도록함
        ...
        elif ally_drop_item == 'ALL_potion_low':
    ...
    def boss_match(self, int_floor):
        ...
        self.list_hp = random.sample(range(200, 1000), k=int_cnt)
        self.list_area = random.choices(['fire_area', 'water_area', 'forest_area', 'snow_area'], k=int_cnt)
    ...
    # 텔레포트 사용 후 재입장시 이동위치
    def reentry_maze(self, int_floor):
        self.int_floor = int_floor
